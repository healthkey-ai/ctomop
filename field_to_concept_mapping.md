...
| `cytogenic_markers` | Observation; 40758361; LOINC `55232-3` — Genetic analysis summary panel | PatientRecord edit retained; no active projection. Existing proposal requires review; not automatically approved. |
