...
| `cytogenic_markers` | Observation; per-value standard SNOMED categories — [all nine mappings](docs/cytogenetic-markers.md) | Multiselect PATCH creates one coded Observation per marker; exact marker retained in value/source fields. |
