...
2. Personal representative (Identity → PersonalRepresentative → person_id)
3. Professional group access (Identity → ProfessionalGroupAccess → group ∩ patient's groups)
"""
